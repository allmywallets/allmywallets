<template>
  <div class="actions">
    <div class="actions-left">
      <a
        href="#"
        @click.prevent="refreshBalances"
        title="Refresh all balances"
        v-tippy
      >
        <fa-icon icon="sync-alt" :spin="loading" /> </a
      ><!--
      --><a
        href="#"
        @click.prevent="toggleCharts"
        title="Toggle balances charts"
        v-tippy
      >
        <fa-icon icon="chart-area" /> </a
      ><!--
      --><a
        href="#"
        @click.prevent="collapseBalances"
        title="Toggle balances collapsing"
        v-tippy
      >
...
export default {
  ...
  methods: {
    async refreshBalances() {
      return this.$store.dispatch("refreshBalances", {
