<template>
  <aside
    :class="{
      ...
      'show-panel': display.notifications.panel
    }"
  >
    <header class="actions">
      <a
        ...
        ><fa-icon icon="trash"
      /></a>
      <a href="#" @click.prevent="togglePanel" class="close-panel"
        ><fa-icon icon="times"
      /></a>
    </header>
    <p class="overall" v-if="notifications.length === 0">
      <fa-icon icon="inbox" /> <br />
      <translate>You don't have any notifications.</translate>
    </p>
