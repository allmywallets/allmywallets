  ...
  describe("getBalanceDiff()", () => {
    it("returns a diff with new balance amount when no old balance", () => {
      const newBalance = new Balance(
        new Wallet("id", "MyWallet", "ethereum", "native"),
        "0x0",
        "ethereum",
        "ETH",
        5,
      ...
      expect(BalanceManager.getBalanceDiff(null, newBalance)).toEqual({
        amount: 5,
        balance: newBalance,
        transactions: [
          new Transaction(
    ...
    it("returns a valid diff increase", () => {
      ...
      expect(BalanceManager.getBalanceDiff(oldBalance, newBalance)).toEqual({
        amount: 2,
        balance: newBalance,
        transactions: [
          new Transaction(
  ...
  describe("compareBalances()", () => {
    it("computes diffs for all related balances", () => {
      ...
      const oldBalances = [
        ...
        new Balance(
          new Wallet("id", "MyWallet", "iota", "native"),
          "0x1",
          "iota",
          "IOTA",
          10,
        ...
        new Balance(
          new Wallet("id", "MyWallet", "bitcoin", "native"),
          "0x2",
          "bitcoin",
          "BTC",
          1,
      ...
      expect(BalanceManager.compareBalances(oldBalances, newBalances)).toEqual([
        {
          amount: -2,
